...
import zeroturnaround.org.jrebel4androidgettingstarted.MainActivity;
import zeroturnaround.org.jrebel4androidgettingstarted.NavigationMenuAdapter;
    ...
    private static class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public ViewHolder(View itemView, EventItemListener listener) {
                ...
                title = (TextView) itemView.findViewById(R.id.quote_author);
                description = (TextView) itemView.findViewById(R.id.quote_text);
